...
export default function BannersView({ isDarkMode, showToast, refresh, categories, products }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-serif text-2xl font-black">Homepage Banners</h2>
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/60">
            <div className="grid gap-5 2xl:grid-cols-[minmax(0,1.5fr)_minmax(240px,0.7fr)]">
              ...
              <div className="flex flex-col justify-center">
                <h4 className="text-sm font-black text-slate-950 dark:text-slate-50">Banner image</h4>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-1 rounded-full bg-white px-4 py-2 text-xs font-black text-slate-950 shadow-sm ring-1 ring-slate-200 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-slate-900 dark:text-slate-100 dark:ring-slate-700"
                  >
            ...
            <button
              ...
              className="mt-5 w-full rounded-lg bg-indigo-700 px-6 py-2.5 text-xs font-black uppercase tracking-wide text-white shadow-lg hover:bg-indigo-800"
            >
              Create Banner
            </button>
          </div>
