    ...
    <div className={commonStyles.modalOverlay}>
      <div className={`${commonStyles.modalContent} max-w-sm`}>
        <div className="flex justify-between items-center border-b border-slate-150 dark:border-slate-800 pb-2.5">
          <h3 className="font-bold text-lg font-serif text-slate-900 dark:text-slate-100">Advance Product Request</h3>
          <button 
            type="button"
            onClick={onClose} 
        ...
        <form onSubmit={handleRequestSubmit} className="space-y-3.5 pt-1 text-xs">
          ...
          {requestSuccess && <p className="text-[11px] text-emerald-600 dark:text-emerald-400 font-bold leading-normal">{requestSuccess}</p>}
