            ...
            >
              ...
              >
                ...
                <div className="min-w-0 flex-1 space-y-1.5">
                  <h4 className="text-sm font-medium tracking-normal line-clamp-2 group-hover:text-indigo-600  transition-colors">{prod.name}</h4>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="p-2 border border-slate-200  rounded-full text-slate-500 hover:text-indigo-600  bg-slate-50  transition-all active:scale-95"
                  title="Share Product"
                >
