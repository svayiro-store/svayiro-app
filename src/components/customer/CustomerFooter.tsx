        ...
        return (
          <div className="space-y-4">
            <div className="flex items-center gap-3 pb-3 border-b border-slate-100 ">
              ...
              <h3 className="font-serif font-semibold text-lg text-slate-900 ">About {shop.name}</h3>
            </div>
        ...
        return (
          <div className="space-y-4">
            <div className="flex items-center gap-3 pb-3 border-b border-slate-100 ">
              ...
              <h3 className="font-serif font-semibold text-lg text-slate-900 ">Contact Our Hub</h3>
            </div>
            ...
            <div className="space-y-3 pt-1">
              <div className="flex items-start gap-3 p-3 bg-slate-50  rounded-xl border border-slate-200/50 ">
                <MapPin className="h-4 w-4 text-indigo-500 shrink-0 mt-0.5" />
                <div className="text-xs">
                  <span className="font-bold block text-slate-800 ">Registered Address</span>
                  <span className="text-slate-500 ">{shop.address || 'SVAYIRO Headquarters, Bengaluru'}</span>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 bg-slate-50  rounded-xl border border-slate-200/50 ">
                <Phone className="h-4 w-4 text-indigo-500 shrink-0 mt-0.5" />
                <div className="text-xs">
                  <span className="font-bold block text-slate-800 ">Customer Support Line</span>
                  <span className="text-slate-500  font-mono">{shop.contactNumber || '+91 98765 43210'}</span>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 bg-slate-50  rounded-xl border border-slate-200/50 ">
                <Mail className="h-4 w-4 text-indigo-500 shrink-0 mt-0.5" />
                <div className="text-xs">
                  <span className="font-bold block text-slate-800 ">Email Desk</span>
                  <span className="text-slate-500  font-mono">{shop.email || 'support@svayiro.com'}</span>
                </div>
              </div>
            </div>
      ...
      case 'faq':
        return (
          <div className="space-y-4 max-h-[400px] overflow-y-auto pr-1">
              <div className="flex items-center gap-3 pb-3 border-b border-slate-200  sticky top-0 bg-white  z-10">
              <HelpCircle className="h-5 w-5 text-indigo-500" />
              <h3 className="font-serif font-semibold text-lg text-slate-900 ">Frequently Asked Questions</h3>
            </div>
            <div className="space-y-4 pt-1">
              <div className="space-y-1">
                <h4 className="text-xs font-semibold text-slate-800 ">Q1. How does the Dynamic UPI QR payment work?</h4>
              ...
              <div className="space-y-1">
                <h4 className="text-xs font-semibold text-slate-800 ">Q2. Can I schedule or reserve a customized product?</h4>
                <p className="text-[11px] leading-relaxed text-slate-500 ">
              ...
              <div className="space-y-1">
                <h4 className="text-xs font-semibold text-slate-800 ">Q3. How can I cancel an active order?</h4>
                <p className="text-[11px] leading-relaxed text-slate-500 ">
              ...
              <div className="space-y-1">
                <h4 className="text-xs font-semibold text-slate-800 ">Q4. When will my order be delivered?</h4>
                <p className="text-[11px] leading-relaxed text-slate-500 ">
  ...
  return (
    <>
      <footer className={`border-t transition-colors ${
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              />
              <h3 className="font-serif font-semibold text-lg text-indigo-600 ">
                {shop.name}
              </h3>
            </div>
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {socialLinks.map((link, index) => (
                  <a
                    ...
                    rel="noreferrer"
                    title={link.label}
                    className="inline-flex max-w-[140px] items-center rounded-full border border-slate-200 bg-white px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-indigo-700 shadow-sm transition hover:bg-slate-50 hover:text-indigo-900    "
                  >
            ...
            <ul className="space-y-2.5 text-xs">
              <li>
                <button
                  ...
                  className="flex items-center gap-2 hover:text-indigo-500  transition-colors text-left font-medium opacity-85 hover:opacity-100"
                >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-xs leading-relaxed">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="font-semibold text-slate-700 ">Daily Operations</p>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="font-semibold text-slate-700 ">Quality Verified</p>
            ...
            <div className="pt-2 flex flex-col gap-2">
              ...
              {!activeUser && (
                <button
                  ...
                  className="w-full border border-indigo-200  bg-indigo-50/50  text-indigo-600  hover:bg-indigo-100  py-2 rounded-xl text-xs font-bold transition flex items-center justify-center gap-2"
                >
        ...
        {/* Footer Bottom Bar */}
        <div className="max-w-7xl mx-auto mt-6 pt-6 border-t border-slate-100/60  flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] font-mono opacity-85">
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[200] flex items-center justify-center p-4 animate-fadeIn">
          <div className={`relative flex max-h-[88vh] w-full max-w-lg flex-col overflow-hidden rounded-2xl border shadow-xl transition-all animate-scaleUp ${
            ...
            <button
              ...
              className="absolute right-4 top-4 z-20 rounded-full p-1 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600  "
            >
              <X className="h-4 w-4" />
            </button>
